...
app.translations = {
  ...
  ,es: {
        place_router:"Haga clic en el lugar donde desea colocar el enrutador.",
        place_host:"Por favor, haga clic en donde desea colocar el host.",
        choose_start:"Seleccione un punto de inicio.",
        alert_connection:"Al menos 2 hosts deben estar conectados a la red.",
        choose_sender:"Seleccione un remitente.",
        choose_sender_click:"Elija un remitente.",
        choose_destination:"Seleccione un receptor.",
        confirm:"Confirmar",
        choose_destination_click:"Elija un receptor.",
        same_sender_and_receiver:"Origen y destino son los mismos.",
        destination_address:"Dirección IP de destino:",
        hover:"Cuando coloca el cursor sobre un objeto, muestra la dirección IP de ese objeto.",
        quick_speed:"Rápido",
        medium_speed:"Medio",
        slow_speed:"Lento",
        start:"Empezar",
        ...
        host:"Host",
        path:'Camino',
        choose_end:"Seleccione un punto final.",
        clear:"Borrar",
        ...
        left:"a la izquierda",
        help:"Ayuda",
        intro_first_start:"Este programa permite simular el funcionamiento de una red, en particular el envío de paquetes de un host a otro a través de routers. En primer lugar, agregue routers y hosts y, a continuación, conéctelos entre sí para empezar.",
        intro:"Este programa puede simular el funcionamiento de una red, en particular el envío de paquetes de un host a otro a través de routers.",
        intro_router:"Utilice este botón para agregar un router a la red actual.",
        intro_host:"Utilice este botón para agregar un host a la red actual.",
        intro_path:"Utilice este botón para vincular dos objetos entre sí. Advertencia: ¡un host solo puede ser enlazado a un objeto!",
        intro_confirm:"Utilice este botón para continuar una vez que su red esté completa.",
        intro_clear:"Utilice este botón para borrar completamente la red actual.",
        intro_help:"Utilice este botón para volver a ver esta presentación.",
        intro_language:"Utilice este menú desplegable para cambiar el idioma de la interfaz.",
        cancel:"Vueltar",
        intro_step2:"Seleccione el host de envío y, a continuación, pulse 'Confirmar'. A continuación, seleccione el host receptor y, a continuación, pulse 'Confirmar'. Puede volver a la pantalla anterior pulsando 'Vueltar'.",
        intro_start:"Utilice este botón para iniciar la animación automatizada completa.",
        intro_step:"Utilice este botón para iniciar la animación paso a paso.",
        intro_modify:"Utilice este botón para volver a la pantalla de modificación de red.",
        intro_speed:"Utilice este menú desplegable para cambiar la velocidad de la animación.",
        intro_step3:"Ahora que la red está configurada, el programa será capaz de iniciar una simulación animada de la ruta recorrida por un paquete entre dos hosts.",
        explanations:"Explique",
        intro_explanations:"Utilice este botón para leer explicaciones sobre los resultados de la simulación.",
        intro_table_row:"Esta tabla describe toda la red creada para la simulación. La red de destino se escribe en rojo.",
        intro_destination:"Esta columna muestra las direcciones de red creadas para esta simulación. En rojo, la dirección de red de destino.",
        intro_interface:"Esta columna muestra las interfaces del router actual. En rojo, la interfaz que se utilizará para el salto siguiente.",
        intro_nexthop:"Esta columna muestra las direcciones IP que se pueden alcanzar en el salto siguiente. En rojo, la dirección IP del próximo router o el host de destino si sólo se necesita un salto.",
        intro_metric:"Esta columna muestra el número de saltos necesarios para llegar a la red descrita a la izquierda. En rojo, el número de saltos necesarios para llegar a la red de destino.",
        intro_ttl_count:"Esta es el  tiempo de vida (Time To Live) del paquete. Este valor disminuye en 1 cada salto. Si llega a 0 antes de que el paquete llegue a destino, la transmisión de paquetes falla. Esto es para evitar que el paquete termine en un bucle de enrutamiento infinito.",
        link:"Cuestionario",
        url:"https://goo.gl/k6LLzJ",
    }
    ,ja:{
  ...
  ,fr:{
      ...
      alert_connection:"Veuillez connecter au moins deux hôtes au réseau actuel.",
      ...
      destination_address:"Adresse IP de destination : ",
      ...
      intro_ttl_count:"Ici, la durée de vie restante (Time To Live) du paquet. Cette valeur décroit de 1 à chaque hop. Si elle atteint 0 avant que le paquet soit arrivé à destination, la transmission du paquet échoue. Cela sert à éviter que le paquet ne se retrouve dans une boucle de routage infinie.",
      link:"Questionnaire",
      url:"https://goo.gl/wDZFDh",
  },
  pt:
  {
    place_router:"Por favor, clique onde deseja colocar o router.",
    place_host:"Por favor, clique onde deseja colocar o host.",
    choose_start:"Selecione um ponto inicial (ponto de partida).",
    ...
    destination_address:"Endereço IP de destino:",
    hover:"Quando passa o mouse sobre um objeto, ele exibe o endereço IP desse objeto.",
    quick_speed:"Rápido",
    medium_speed:"Médio",
    slow_speed:"Lento",
    start:"Começar",
    ...
    left:"na esquerda",
    help:"Ajuda",
    intro_first_start:"Este programa simula o funcionamento de uma rede, em particular o envio de pacotes a partir de um host para outro através de routers. Primeiro adicione routers e hosts, em seguida, conectá-los juntos para começar.",
    intro:"Este programa pode simular a operação de uma rede, em particular o envio de pacotes de um host para outro através de routers.",
    intro_router:"Use este botão para adicionar um router à rede atual.",
    ...
    intro_confirm:"Use este botão para continuar quando sua rede estiver completa.",
    intro_clear:"Use este botão para apagar a rede atual inteiramente.",
    intro_help:"Use este botão para ver novamente esta apresentação.",
    intro_language:"Use este menu suspenso para alterar o idioma deste software.",
    cancel:"Voltar",
    intro_step2:"Selecione o host de envio e, em seguida, toque em 'Confirmar'. Em seguida, selecione o host de recebimento e depois toque em Confirmar. Você pode voltar à tela anterior pressionando 'Voltar'.",
    ...
    intro_modify:"Use este botão para voltar à tela de criação de rede.",
    ...
    intro_destination:"Esta coluna lista os endereços de rede criados para esta simulação. Em vermelho, o endereço da rede de destino.",
    intro_interface:"Esta coluna lista as interfaces do router atual. Em vermelho, a interface que será usada para o próximo salto.",
    intro_nexthop:"Esta coluna lista os endereços IP que podem ser alcançados no próximo salto. Em vermelho, o endereço IP do próximo router ou o host de destino, se apenas um salto for necessário.",
    intro_metric:"Esta coluna lista o número de saltos necessários para alcançar a rede descrita na esquerda. Em vermelho, o número de salto necessário para alcançar a rede de destino.",
    intro_ttl_count:"Aqui está o tempo de vida útil (Time To Live) do pacote. Esse valor diminui em 1 em cada salto. Se atingir 0 antes do pacote chegar ao destino, a transmissão falhará. Isto é para evitar que o pacote termine em um loop de roteamento infinito.",
    link:"Questionário",
